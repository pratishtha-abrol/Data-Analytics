...
class BufferManager{
    ...
    void writePage(string pageName, vector<vector<string>> rows);
    void deleteFile(string tableName, int pageIndex);
    void deleteFile(string fileName);
    void writePage(string tableName, int pageIndex, vector<vector<string>> rows, int rowCount);
    void updatePage(Page p);
    void updatePageName(Page p, string Name);
};